...
//   },
//   withCredentials:true //imp for cookies
// });

// let accessToken=localStorage.getItem('accessToken'); // store access token

// // CORRECT - Add token to headers
...
//     // if 401 and not already retired
...
//   getAllUsers: (userId) => api.get('/users/all', { params: { userId } }),
//   searchUsers: (query, userId) => api.get('/users/search', { params: { query, userId } }),
...
//   getMessages: (userId, otherUserId, limit = 50, skip = 0) => 
//     api.get('/messages/conversation', { params: { userId, otherUserId, limit, skip } }),
//   getGroupMessages: (groupId, limit = 50, skip = 0) => 
//     api.get('/messages/group', { params: { groupId, limit, skip } }),
//   markAsRead: (messageId, userId) => api.post('/messages/read', { messageId, userId }),
//   deleteMessage: (messageId, userId) => api.delete('/messages/delete', { data: { messageId, userId } }),
//   getRecentConversations: (userId) => api.get('/messages/recent', { params: { userId } }),
// };

// // Group APIs
// export const groupAPI = {
//   createGroup: (data) => api.post('/groups/create', data),
//   getUserGroups: (userId) => api.get('/groups/user', { params: { userId } }),
...
//   leaveGroup: (groupId, userId) => api.post('/groups/leave', { groupId, userId }),
// };
