...
//   return (
//     <header className="h-16 sm:h-20 bg-white border-b border-gray-200 flex items-center justify-between px-4 sm:px-6 shadow-sm">
...
//         <button 
//           onClick={onMenuClick}
//           className="lg:hidden text-gray-600 hover:text-purple-600 hover:bg-purple-50 p-2 rounded-lg transition-all transform hover:scale-110"
//         >
...
//         <button className="hidden md:flex items-center gap-2 px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-600 rounded-lg transition-all">
//           <Search className="w-5 h-5" />
//           <span className="text-sm font-medium">Search</span>
//         </button>

//         {/* Search Button (Mobile) */}
//         <button className="md:hidden text-gray-600 hover:text-purple-600 hover:bg-purple-50 p-2 rounded-lg transition-all">
//           <Search className="w-5 h-5" />
//         </button>

//         {/* Notifications */}
//         {showNotifications && (
//           <button className="relative text-gray-600 hover:text-purple-600 hover:bg-purple-50 p-2 rounded-lg transition-all transform hover:scale-110">
...
//         {/* More Options */}
//         <button className="text-gray-600 hover:text-purple-600 hover:bg-purple-50 p-2 rounded-lg transition-all transform hover:scale-110">
