...
//   return (
//     <div className="w-20 bg-gradient-to-b from-purple-700 via-violet-700 to-indigo-800 flex flex-col items-center py-6 space-y-6 shadow-2xl relative">
      
//       {/* Close button for mobile */}
//       {onClose && (
//         <button
//           onClick={onClose}
//           className="md:hidden absolute top-4 right-4 text-white hover:bg-white hover:bg-opacity-20 p-2 rounded-lg transition-all"
//         >
//           <X className="w-5 h-5" />
//         </button>
//       )}
...
//       {/* Divider */}
//       <div className="w-12 h-px bg-white bg-opacity-20"></div>
...
//               className={`relative p-3 rounded-xl transition-all duration-300 transform hover:scale-110 group ${
//                 isActive
...
//               {isActive && (
//                 <>
//                   <span className="absolute -right-2 top-1/2 transform -translate-y-1/2 w-1 h-8 bg-white rounded-l shadow-lg"></span>
//                   <span className="absolute inset-0 bg-white opacity-10 rounded-xl animate-pulse"></span>
//                 </>
//               )}

//               {/* Tooltip on hover (desktop only) */}
//               <span className="hidden md:block absolute left-full ml-4 px-3 py-2 bg-gray-900 text-white text-sm rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap pointer-events-none z-50 shadow-xl">
//                 {tab.label}
...
//         className="p-3 text-purple-200 hover:text-white hover:bg-red-500 hover:bg-opacity-20 rounded-xl transition-all duration-300 transform hover:scale-110 group relative"
//         title="Logout"
//       >
...
//         <button
//           onClick={onClose}
//           className="lg:hidden absolute top-4 right-4 text-white hover:bg-white hover:bg-opacity-20 p-2 rounded-lg transition-all z-50"
//         >
//           <X className="w-5 h-5" />
//         </button>
//       )}
