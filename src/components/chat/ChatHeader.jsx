// // // import { Phone, Video, MoreVertical, Users, ArrowLeft, Search } from 'lucide-react';
// // // import Avatar from '../common/Avatar';
// // // import { formatLastSeen } from '../../utils/helper';
// // // import { useSocket } from '../../context/SocketContext';

// // // const ChatHeader = ({ contact, isGroup = false, memberCount = 0, onBack }) => {
// // //   const { onlineUsers } = useSocket();
// // //   const isOnline = contact && onlineUsers.has(contact._id || contact.id);

// // //   return (
// // //     <div className="h-16 sm:h-20 bg-gradient-to-r from-purple-600 via-violet-600 to-indigo-600 shadow-lg flex items-center justify-between px-4 sm:px-6">
...
// // //           <div className="absolute -inset-1 bg-gradient-to-r from-pink-500 to-yellow-500 rounded-full opacity-75 group-hover:opacity-100 blur transition-all"></div>
// // //           <div className="relative">
// // //             <Avatar user={contact} size="md" showOnline={!isGroup && isOnline} />
// // //           </div>
// // //         </div>
...
// // //         <button className="hidden sm:flex text-white hover:bg-white hover:bg-opacity-20 p-2 rounded-lg transition-all transform hover:scale-110">
// // //           <Search className="w-5 h-5" />
// // //         </button>

// // //         {/* Voice Call */}
// // //         <button className="text-white hover:bg-white hover:bg-opacity-20 p-2 rounded-lg transition-all transform hover:scale-110">
