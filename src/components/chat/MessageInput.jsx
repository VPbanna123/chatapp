...
const MessageInput = ({ onSend, onTyping, replyTo = null, onCancelReply }) => {
  ...
  return (
    <>
      ...
      <div 
        className="bg-gradient-to-r from-purple-50 via-white to-indigo-50 border-t-2 border-purple-200 px-3 sm:px-4 lg:px-6 shadow-lg flex-shrink-0"
        style={{
          paddingTop: '0.75rem',
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex items-end gap-1.5 sm:gap-2 lg:gap-3 pb-2">
          <button
            type="button"
