...
//         <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-white opacity-70 z-10 pointer-events-none" />
//         <input
//           type="text"
//           value={searchQuery}
//           onChange={(e) => setSearchQuery(e.target.value)}
//           placeholder="Search users..."
//           className="w-full pl-11 pr-10 py-3 bg-white rounded-xl border-2 border-purple-300 text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-4 focus:ring-purple-200 focus:border-purple-500 transition-all font-medium shadow-sm"
//         />
//         {searchQuery && (
//           <button
//             onClick={handleClear}
...
//           {/* Results Container */}
//           <div className="absolute left-0 right-0 top-full mt-2 bg-white border border-gray-200 rounded-xl shadow-2xl z-50 max-h-96 overflow-y-auto">
//             {loading ? (
...
//                 <div className="px-4 py-2 bg-gradient-to-r from-purple-50 to-indigo-50">
...
//                     className="flex items-center justify-between p-3 hover:bg-gradient-to-r hover:from-purple-50 hover:to-indigo-50 cursor-pointer transition-all group"
//                   >
...
//                         <h4 className="font-semibold text-gray-800 truncate group-hover:text-purple-900 transition-colors">
//                           {result.username}
//                         </h4>
...
//                       <div className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white p-2 rounded-lg group-hover:scale-110 transition-transform shadow-md">
