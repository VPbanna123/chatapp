...
//           <Avatar user={contact} size="md" showOnline={isOnline} />
//         </div>
//       </div>
...
//               <span className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white text-xs font-bold rounded-full px-2 py-0.5 flex-shrink-0 shadow-md">
