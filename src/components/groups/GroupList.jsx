...
//   return (
//     <div className="w-full sm:w-80 bg-white border-r border-gray-200 flex flex-col shadow-lg">
...
//             {/* Group Counter */}
//             <div className="flex items-center gap-1.5 bg-white bg-opacity-20 px-3 py-1 rounded-full">
...
//               className="bg-white bg-opacity-20 hover:bg-opacity-30 text-white p-2.5 rounded-xl transition-all transform hover:scale-110 active:scale-95 shadow-lg backdrop-blur-sm"
...
//             <div className="w-24 h-24 bg-gradient-to-br from-purple-100 to-indigo-100 rounded-full flex items-center justify-center mb-4 relative">
//               <Users className="w-12 h-12 text-purple-600" />
//               <div className="absolute -top-2 -right-2 bg-yellow-500 rounded-full p-2 border-2 border-white shadow-lg animate-bounce">
...
//             <button
//               onClick={() => setShowCreateGroup(true)}
//               className="px-6 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white font-semibold rounded-xl transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 active:translate-y-0 flex items-center gap-2"
//             >
